...
HOST_NAME = '192.168.0.17'   # Server IP address 
...
if __name__ == '__main__':
    ...
    # We start a server_class and create httpd object and pass our server IP,port number and class handler(MyHandler)
